...
import { Youtube, User, Mail, Lock, Eye, EyeOff, ArrowRight } from 'lucide-react'
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div
                className="flex items-center gap-3 rounded-xl border px-4 py-3 focus-within:ring-2"
                style={{ background: 'var(--color-surface-elevated)', borderColor: 'var(--color-border)' }}
              >
                <User className="h-4 w-4 flex-shrink-0" style={{ color: 'var(--color-text-secondary)' }} />
                <input
                  type="text"
                  value={name}
            ...
            <motion.button
              ...
              whileHover="hover"
              whileTap="tap"
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-white font-semibold text-sm shadow-lg disabled:opacity-60"
          ...
          <p className="mt-6 text-center text-sm" style={{ color: 'var(--color-text-secondary)' }}>
            ...
            <a href="/login" className="font-semibold hover:underline" style={{ color: 'var(--color-accent)' }}>
              Sign in
            </a>
          </p>
        </motion.div>
